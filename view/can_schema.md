...
- [CAN协议Schema存在性论证与多维转换体系](#can协议schema存在性论证与多维转换体系)
  ...
  - [1. 核心结论：存在性确认](#1-核心结论存在性确认)
    - [1.1 CAN Schema分层结构思维导图](#11-can-schema分层结构思维导图)
      - [🗺️ CAN协议Schema体系](#️-can协议schema体系)
    - [1.2 CAN协议标准对比矩阵](#12-can协议标准对比矩阵)
      - [📊 CAN协议标准对比](#-can协议标准对比)
...
| 标准 | 应用领域 | 帧格式 | 数据长度 | 波特率 | 特点 | 标准号 |
|------|----------|--------|----------|--------|------|--------|
| **CAN 2.0A** | 通用 | 标准帧 | 0-8字节 | 5k-1Mbps | 11位ID | ISO 11898-1 |
| **CAN 2.0B** | 通用 | 扩展帧 | 0-8字节 | 5k-1Mbps | 29位ID | ISO 11898-1 |
| **CAN FD** | 高性能 | 扩展帧 | 0-64字节 | 500k-12Mbps | 可变速率 | ISO 11898-1 |
| **SAE J1939** | 商用车 | 扩展帧 | 0-8字节 | 250k/500kbps | 参数组 | SAE标准 |
| **CANopen** | 工业自动化 | 标准/扩展 | 0-8字节 | 10k-1Mbps | 对象字典 | CiA 301 |
