...
- [IoT传感器通信、参数与控制Schema存在性论证](#iot传感器通信参数与控制schema存在性论证)
  ...
  - [1. 核心结论：五维Schema体系完备存在](#1-核心结论五维schema体系完备存在)
    - [1.1 IoT Schema五维体系思维导图](#11-iot-schema五维体系思维导图)
      - [🗺️ IoT传感器Schema体系全景](#️-iot传感器schema体系全景)
    - [1.2 IoT协议对比矩阵](#12-iot协议对比矩阵)
      - [📊 IoT通信协议对比](#-iot通信协议对比)
...
| 协议 | 类型 | 传输方式 | 数据量 | 功耗 | 距离 | 应用场景 | 标准 |
|------|------|----------|--------|------|------|----------|------|
| **Modbus** | 有线 | 串行/以太网 | 中 | 中 | 1.2km | 工业控制 | GB/T19582 |
| **CAN** | 有线 | 总线 | 小 | 低 | 40m | 汽车/工业 | ISO 11898 |
| **MQTT** | 无线 | TCP/IP | 小 | 低 | 无限制 | IoT云平台 | OASIS |
| **CoAP** | 无线 | UDP/IP | 小 | 极低 | 无限制 | 受限设备 | RFC 7252 |
| **LoRaWAN** | 无线 | 射频 | 极小 | 极低 | 15km | 广域IoT | LoRa Alliance |
| **Zigbee** | 无线 | 射频 | 小 | 低 | 100m | 智能家居 | IEEE 802.15.4 |
