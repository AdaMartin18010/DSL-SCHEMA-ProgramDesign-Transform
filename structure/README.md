...
graph TB
    ...
    Root --> Global[全局关系梳理]
    Root --> Expansion[扩展主题与任务]
    Root --> View[树形结构论证]

    Global --> G1[GLOBAL_THEME_RELATIONSHIP_ANALYSIS]
    Global --> G2[DETAILED_THEME_CONVERSION_PATHS]
    Global --> G3[THEME_STANDARD_MAPPING_ANALYSIS]
    Global --> G4[THEME_APPLICATION_SCENARIOS_ANALYSIS]
    Global --> G5[GLOBAL_RELATIONSHIP_COMPLETION_REPORT]
    Global --> G6[GLOBAL_RELATIONSHIP_QUICK_REFERENCE]

    Expansion --> E1[EXPANSION_THEMES_AND_TASKS]
    Expansion --> E2[EXPANSION_VISUALIZATION]
