...
- **IEC 60335-1:2020+AMD1:2025** (Edition 6.1)：家用电器安全标准
- **IEC 61131-3**：工厂自动化标准
- **IEC 61850**：变电站通信标准
- **IEC 63278-1:2024**：数字孪生系统 (Digital Twin System)
- **ISO/IEC 23247:2021**：数字孪生参考架构
- **ISO 10303** (STEP) 系列：工业自动化系统与集成产品数据表示和交换
- **ISO 14649** (STEP-NC)：工业自动化系统和集成 物理设备控制
...
> ⚠️ **更正说明**：~~GB/T 41479-2022~~ 原为错误引用（实际为"信息安全技术 网络数据处理安全要求"），现更正为 **GB/T 43441.1** 作为数字孪生领域的正确国家标准。
...
- **IEC 60335-1:2020+AMD1:2025** 家用电器安全标准 (Edition 6.1)
- **IEC 63278-1:2024** Digital Twin System
- **ISO/IEC 23247:2021** Digital Twin - Reference Architecture
- **ISO/IEC 23247-100:2025** 技术报告 - 半导体晶体生长数字孪生用例
- **GB/T 43441.1** 信息技术 数字孪生 第1部分：通用要求
- **GB/T 19903** 工业设备控制标准
