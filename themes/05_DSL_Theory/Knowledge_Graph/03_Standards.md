...
| **PostgreSQL JSONB** | 关系数据库 | JSONB | ⚠️ 基础 | ✅ SQL | ✅ 已发布 |
| **Apache AGE** | 图扩展 | 属性图 | ⚠️ 中 | ✅ Cypher | ✅ 已发布 |
| **ArangoDB** | 多模型 | 属性图 | ⚠️ 中 | ✅ AQL | ✅ 已发布 |
...
| **PostgreSQL JSONB** | ✅ 完整 | ✅ 完整 | ✅ 完整 | ⚠️ 基础 | ✅ 强 |
| **Apache AGE** | ✅ 完整 | ✅ 完整 | ✅ 完整 | ⚠️ 部分 | ✅ 强 |
| **ArangoDB** | ✅ 完整 | ✅ 完整 | ✅ 完整 | ⚠️ 部分 | ✅ 强 |
...
| **PostgreSQL** | ✅ 完整 | ⚠️ 部分 | ✅ 完整 | ✅ 完整 | ✅ 完整 |
| **Apache AGE** | ⚠️ 部分 | ❌ 无 | ⚠️ 部分 | ✅ 完整 | ✅ 完整 |
| **ArangoDB** | ⚠️ 部分 | ❌ 无 | ⚠️ 部分 | ✅ 完整 | ✅ 完整 |
