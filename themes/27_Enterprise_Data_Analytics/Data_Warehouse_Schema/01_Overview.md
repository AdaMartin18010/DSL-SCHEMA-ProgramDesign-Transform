...
- [数据仓库Schema概述](#数据仓库schema概述)
  ...
  - [4. 标准对标](#4-标准对标)
    - [4.1 Kimball维度建模标准](#41-kimball维度建模标准)
    - [4.2 Data Vault标准](#42-data-vault标准)
    - [4.3 Inmon企业信息工厂标准](#43-inmon企业信息工厂标准)
  - [5. 应用场景](#5-应用场景)
    - [5.1 数据仓库设计](#51-数据仓库设计)
    - [5.2 数据仓库实施](#52-数据仓库实施)
    - [5.3 数据仓库应用](#53-数据仓库应用)
