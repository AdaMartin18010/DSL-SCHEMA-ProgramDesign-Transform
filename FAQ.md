...
- [常见问题（FAQ）](#常见问题faq)
  ...
  - [5. 数据库存储](#5-数据库存储)
    - [5.1 项目支持哪些数据库存储方案？](#51-项目支持哪些数据库存储方案)
    - [5.2 如何实现Schema数据的数据库存储？](#52-如何实现schema数据的数据库存储)
    - [5.3 数据库存储的性能如何？](#53-数据库存储的性能如何)
    - [5.4 如何查询和分析存储的数据？](#54-如何查询和分析存储的数据)
  - [6. 文档相关](#6-文档相关)
    - [6.1 如何查找文档？](#61-如何查找文档)
    - [6.2 文档格式规范是什么？](#62-文档格式规范是什么)
    - [6.3 如何贡献文档？](#63-如何贡献文档)
  - [7. 代码相关](#7-代码相关)
    - [7.1 有可用的代码模板吗？](#71-有可用的代码模板吗)
    - [7.2 如何运行代码示例？](#72-如何运行代码示例)
    - [7.3 如何贡献代码？](#73-如何贡献代码)
  - [8. 理论相关](#8-理论相关)
    - [8.1 形式化证明在哪里？](#81-形式化证明在哪里)
    - [8.2 信息论如何应用？](#82-信息论如何应用)
    - [8.3 知识图谱如何使用？](#83-知识图谱如何使用)
  - [9. 问题解决](#9-问题解决)
    - [9.1 遇到问题怎么办？](#91-遇到问题怎么办)
    - [9.2 如何报告Bug？](#92-如何报告bug)
    - [9.3 如何获取帮助？](#93-如何获取帮助)
  - [10. 其他问题](#10-其他问题)
    - [10.1 项目有许可证吗？](#101-项目有许可证吗)
    - [10.2 如何跟踪项目更新？](#102-如何跟踪项目更新)
    - [10.3 如何参与项目？](#103-如何参与项目)
  - [11. 参考资源](#11-参考资源)
    - [11.1 项目文档](#111-项目文档)
    - [11.2 外部资源](#112-外部资源)
...
- ✅ **PostgreSQL**：主要关系型数据库，支持JSONB、全文搜索
- ✅ **TimescaleDB**：时序数据库扩展，用于传感器数据存储
- ✅ **Apache AGE**：图数据库扩展，用于知识图谱存储
- ✅ **Neo4j**：原生图数据库
- ✅ **ArangoDB**：多模型数据库
...
详见：`themes/DATABASE_STORAGE_EXPANSION_SUMMARY.md`

### 5.2 如何实现Schema数据的数据库存储？

**实现步骤**：

1. **选择存储方案**：根据数据类型选择PostgreSQL、TimescaleDB或图数据库
2. **设计数据表**：参考各Schema的转换文档中的数据库存储章节
3. **实现存储类**：使用提供的代码模板实现存储类
4. **配置数据库**：设置数据库连接和索引

**代码示例**：

详见各Schema的`04_Transformation.md`文档，例如：

- `themes/01_Industrial_Automation/CAN_Schema/04_Transformation.md` 第8章
- `themes/01_Industrial_Automation/PLC_Schema/04_Transformation.md` 第8章
- `themes/02_IoT_Schema/Sensor_Schema/04_Transformation.md` 第8章

### 5.3 数据库存储的性能如何？

**性能指标**：

| 数据类型 | 数据量 | 存储时间 | 查询时间 | 性能评级 |
|---------|--------|---------|---------|---------|
| **传感器读数** | 100万 | < 12分钟 | < 35ms | ⭐⭐⭐⭐⭐ |
| **CAN消息** | 100万 | < 13分钟 | < 50ms | ⭐⭐⭐⭐⭐ |
| **PLC运行时值** | 100万 | < 14分钟 | < 50ms | ⭐⭐⭐⭐⭐ |
...
详见：`themes/DATABASE_STORAGE_EXPANSION_SUMMARY.md` 第5章
...
详见各Schema的`04_Transformation.md`文档中的数据分析查询章节
